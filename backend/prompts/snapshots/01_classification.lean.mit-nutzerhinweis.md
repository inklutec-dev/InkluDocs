...
- **Demo-Werte:**
  ...
  - Kontext: Dokumentkontext plus Nutzerhinweis
...
Das ist unser Workshop am 5. Mai mit der Beispiel AG als Kooperationspartner. Bitte den Workshop-Charakter betonen.
Der Hinweis darf Wissen liefern, das dem Bild nicht anzusehen ist, etwa den Bildtyp oder den Namen einer Person; solches Wissen übernimmst du. Sichtbare Fakten kommen immer aus dem Bild: Ein Hinweis kann nichts sichtbar machen, was das Bild nicht zeigt.

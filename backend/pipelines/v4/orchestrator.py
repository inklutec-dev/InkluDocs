...
def _zaehl_block(z: ZaehlOutput) -> str:
    zeilen = ['', '', 'AUFGEZÄHLT', '',
              ...
              'oder "n in einer Reihe, dahinter weitere"; bei "etwa" die Spanne. Für Personen gibt es kein '
              '"etwa": Die Liste zählt sie einzeln, du nennst diese Zahl. Keine Personen und Objekte '

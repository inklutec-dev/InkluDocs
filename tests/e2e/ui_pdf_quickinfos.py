...
with sync_playwright() as p:
    ...
    check("Neues PDF-Projekt: Ansichts-Wahl ohne Quickinfos (noch keine Felder)", pg.locator("#ansichtSelect option").all_text_contents() == ["Dokument", "Alt-Texte"], pg.locator("#ansichtSelect option").all_text_contents())
    ...
    check("Ansichts-Wahl jetzt mit drei Stationen", pg.locator("#ansichtSelect option").all_text_contents() == ["Dokument", "Alt-Texte", "Quickinfos"], pg.locator("#ansichtSelect option").all_text_contents())

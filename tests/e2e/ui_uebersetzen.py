...
with sync_playwright() as p:
    ...
    zweitdokumente_loeschen(pg); pg.goto(B + f"/app?projekt={PID}&ansicht=alttexte"); pg.wait_for_timeout(3000)
    print("== B. Ansicht ==")
    ...
    check("Ansicht-Zeile NACH den Hauptknoepfen wie in der Alt-Text-Ansicht (Review 2, Befund 15)", pg.evaluate("(() => { const a = document.getElementById('uStartBtn'), b = document.getElementById('ansichtSelect'); return !!(a && b) && !!(a.compareDocumentPosition(b) & Node.DOCUMENT_POSITION_FOLLOWING); })()"))
